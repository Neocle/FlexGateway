...
public class PlayersHandler extends EnhancedBaseHandler {

    public PlayersHandler(JavaPlugin plugin, DataManager dataManager, ExtensionLoader extensionLoader) {
